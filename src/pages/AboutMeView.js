        ...
        return (<div css={{ [mediaMaxWidth(768)]: { padding: '50px 10px' }, padding: '60px 300px' }}>
            ...
            <div css={{fontFamily: 'Montserrat', marginTop: '70px', lineHeight: '1.6em'}}>
                <div css={{ textIndent: '50px', lineHeight: '2em' }}>
                    <div>I am willing and intensely passionate on development the full project life cycle from the start to features delivery in challenging environment and standing by 24/7 available every one week a month for project's production on-call support to make sure that our application is fully on servicing.</div>
                    <div>Besides contributing in project delivery, my cultural view of working has a focus on putting a high priority on team's well-being and support all team members' of their career growth. It's my pleasure to jump in if any of my team members need extra supports to solve the issue they are encountering. Also helping to improve our working process and facilitate my teammates to fully accomplish their in-hand tasks without worries.</div>
