...
export default () => (
    <div css={{
        ...
        <div css={{ position: 'absolute', zIndex: '1', fontSize: '90vh', lineHeight: '85vh', color: colorScheme.secondaryBgColor, fontWeight: 'bold', marginLeft: '-50px'}}>{'{'}</div>
        <div css={{ [mediaMaxWidth(768)]: { display: 'none' }, position: 'absolute', zIndex: '1', right: 0, fontSize: '90vh', lineHeight: '85vh', color: colorScheme.secondaryBgColor, fontWeight: 'bold', marginRight: '-50px'}}>{'}'}</div>
        <div css={{ 
